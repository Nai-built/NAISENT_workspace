...
QnA = [
    "what do bees do?<BOS>Bees are small but very important. They fly from flower to flower, and as they move, they help the plants make seeds.<EOS>",
    "why do you believe hope is important?<BOS>Because hope is very important even if it seems small, hope can carry heavy load and help people through their lives<EOS>"
]
...
for _ in range(5000):
    for sample_index in range(len(QnA)):
