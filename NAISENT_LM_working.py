...
laod_container = container("NAISENT/NAISENT_LM_30M_dropout_batching_FT")
load_model(laod_container)

# pre_train(.0003, 1000, 1)
# fine_tune(.0001, 500, 4)

# save_container = container("NAISENT/NAISENT_LM_30M_dropout_batching_FT")
